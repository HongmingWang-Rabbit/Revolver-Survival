...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="game-container svelte-1uha8ag">`);
    Header($$renderer2);
    $$renderer2.push(`<!----> <main class="game-main svelte-1uha8ag"><div class="game-layout svelte-1uha8ag"><aside class="left-panel svelte-1uha8ag">`);
    BetControls($$renderer2);
    $$renderer2.push(`<!----></aside> <section class="center-panel svelte-1uha8ag"><div class="game-scene svelte-1uha8ag">`);
    StickMan($$renderer2);
    $$renderer2.push(`<!----></div> `);
    if (selectedMode) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div${attr_class("mode-badge svelte-1uha8ag", void 0, { "active": gameState !== "idle" })}><span class="mode-bullets svelte-1uha8ag">${escape_html(selectedMode.bullets)} Bullet${escape_html(selectedMode.bullets > 1 ? "s" : "")}</span> <span class="mode-odds svelte-1uha8ag">${escape_html((selectedMode.survivalRate * 100).toFixed(0))}% Survival</span></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></section> <aside class="right-panel svelte-1uha8ag">`);
